        ...
        <div class="reser">
            ...
            <div class="reser_con">
                ...
                <div runat="server" id="reserved">
                        ...
                        <a href="javascript:;" runat="server" id="btnQuickRequestCancel"><span class="btn_grean">서비스취소</span></a>
                </div>
                <div runat="server" id="notReserved">
                    <div style="height:40px;padding-top:30px; text-align:center;">서비스 신청 내역이 없습니다.</div>
                    <a href="javascript:;" runat="server" id="btnQuickRequest"><span class="btn_grean">서비스신청</span></a>
                </div>
            </div>
        </div>
        <div class="harf_con">
